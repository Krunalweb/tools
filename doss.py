...
if name == 'main':
    active = []
    ths = []
    target_request_rate = 1000  # Requests per second
    delay_between_requests = 1 / target_request_rate
    while True:
        try:
            while True:
                ...
                try:
                    ...
                    pass
                time.sleep(delay_between_requests)  # Add a delay between starting threads to achieve the desired request rate
        except:
            pass
